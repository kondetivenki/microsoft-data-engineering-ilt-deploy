...
git clone https://github.com/CloudLabs-MOC/microsoft-data-engineering-ilt-deploy.git asa
...
# Template deployment
$resourceGroupName = (Get-AzResourceGroup | Where-Object { $_.ResourceGroupName -like "*DP203-M17*" }).ResourceGroupName
#$deploymentId =  (Get-AzResourceGroup -Name $resourceGroupName).Tags["DeploymentId"]
. C:\LabFiles\AzureCreds.ps1
$deploymentId = $deploymentID

$url = "https://raw.githubusercontent.com/CloudLabs-MOC/microsoft-data-engineering-ilt-deploy/main/setup/17/spektra/armdeploy.parameters.post.json"
...
New-AzResourceGroupDeployment -ResourceGroupName $resourceGroupName -TemplateUri "https://raw.githubusercontent.com/CloudLabs-MOC/microsoft-data-engineering-ilt-deploy/main/setup/01/spektra/armdeploy-17.json" -TemplateParameterFile "c:\LabFiles\parameters.json"
...
Remove-AzResourceGroupDeployment -ResourceGroupName "DP203-M17" -Name "armdeploy-17"
...
$WebClient = New-Object System.Net.WebClient
$WebClient.DownloadFile("https://raw.githubusercontent.com/CloudLabs-MOC/microsoft-data-engineering-ilt-deploy/main/setup/17/spektra/logontask.ps1","C:\LabFiles\logontask.ps1")
