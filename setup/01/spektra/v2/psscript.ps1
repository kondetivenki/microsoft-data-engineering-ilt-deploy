...
$url = "https://raw.githubusercontent.com/CloudLabs-MOC/microsoft-data-engineering-ilt-deploy/main/setup/01/spektra/v2/armdeploy.parameters.post.json"
...
New-AzResourceGroupDeployment -ResourceGroupName $resourceGroupName -TemplateUri "https://raw.githubusercontent.com/CloudLabs-MOC/microsoft-data-engineering-ilt-deploy/main/setup/01/spektra/v2/armdeploy.json" -TemplateParameterFile "c:\LabFiles\parameters.json"
...
Remove-AzResourceGroupDeployment -ResourceGroupName  $resourceGroupName -Name "armdeploy"
...
$WebClient = New-Object System.Net.WebClient
$WebClient.DownloadFile("https://raw.githubusercontent.com/CloudLabs-MOC/microsoft-data-engineering-ilt-deploy/main/setup/01/spektra/v2/logontask.ps1","C:\LabFiles\logontask.ps1")
